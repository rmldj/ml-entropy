...
#python ising_entropy.py --order 0 --log cv -k 2
#python ising_entropy.py --order 0 --log cv -k 3
#python ising_entropy.py --order 0 --log cv -k 4
#python ising_entropy.py --order 0 --log cv -k 5
